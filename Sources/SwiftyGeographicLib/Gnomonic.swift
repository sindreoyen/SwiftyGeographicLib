...
public func forward(origin: (lat: Double, lon: Double), point: (lat: Double, lon: Double), ellipsoid: (a: Double, f: Double)) -> ForwardResult {
...
public func reverse(origin: (lat: Double, lon: Double), point: (x: Double, y: Double), ellipsoid: (a: Double, f: Double)) -> ReverseResult {
