...
let WGS84 = (a: 6378137.0, f: 1 / 298.257223563)
...
final class SwiftyGeographicLibGeodesicTests: XCTestCase {
    func testGeodesicInverse() throws {
      ...
      let inv = SwiftyGeographicLib.inverse(p1: p1, p2: p2, ellipsoid: WGS84)
      
      XCTAssertEqual(inv.s12,  5551759.400318679, accuracy: 1e-9)
      XCTAssertEqual(inv.a12,  49.94131021789904, accuracy: 1e-9)
  ...
  func testGeodesicDirect() throws {
    ...
    let dir = SwiftyGeographicLib.direct(p1: p1, az1: az1, s12: s12, ellipsoid: WGS84)
  ...
  func testGeodesicArcDirect() throws {
    let p1 = (lat: 40.6, lon: -73.8)  // JFK Airport
    let az1 = 51.19888284557982
    let a12 = 49.94131021789904
    let dir = SwiftyGeographicLib.arcDirect(p1: p1, az1: az1, a12: a12, ellipsoid: WGS84)
